...
<body class="flex flex-col min-h-screen">
  ...
  <div class="flex-grow flex items-center justify-center px-4">
    <div class="w-full max-w-md p-8 space-y-6 bg-white/90 rounded-3xl shadow-lg backdrop-blur relative">
      <!-- Heading -->
      <h2 class="text-2xl font-bold text-center text-primary">Writer Login</h2>
      ...
      <form action="core/handleForms.php" method="POST" class="space-y-6">
        ...
        <div>
          <button type="submit" name="loginUserBtn" class="w-full bg-primary text-white px-5 py-3 rounded-2xl font-semibold text-sm shadow hover:bg-cyan-700">Login</button>
        </div>
      </form>

      <!-- Bottom links -->
      <div class="flex justify-between text-sm text-gray-600 mt-4">
        <a href="../admin/login.php" class="font-medium text-accent hover:underline">Admin Login</a>
