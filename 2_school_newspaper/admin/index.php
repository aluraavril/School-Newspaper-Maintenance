...
<body class="min-h-screen flex flex-col">
  ...
  <div class="w-full px-6 sm:px-8 lg:px-10 flex gap-8 h-[calc(100vh-100px)] mt-6">
    <!-- Left Column: Submit New Admin Article (approx 60%) -->
    <div class="flex-[3] bg-[#FFE066] border-4 border-[#5C3D2E] p-8 rounded-2xl shadow-lg h-fit sticky top-40 self-start">
      ...
      <h3 class="text-xl font-bold text-[#5C3D2E] mb-6">📝 Write Your New Admin Post</h3>
      <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <textarea id="description" name="description" placeholder="Write your admin post here." rows="6"
        ...
        <button type="submit" name="insertAdminArticleBtn"
